...
const menuIconDatas: MenuIconDataProps[] = [
  ...
  { name: 'npm2', id: 6, parentId: 4, icon: 'https://static.npmjs.com/b0f1a8318363185cc2ea6a40ac23eeb2.png', url: '' },
  { name: '百度', id: 7, parentId: 4, icon: 'https://www.baidu.com/favicon.ico', url: '' },
  { name: '百度2', id: 9, parentId: 7, icon: 'https://www.baidu.com/favicon.ico', url: '' },
